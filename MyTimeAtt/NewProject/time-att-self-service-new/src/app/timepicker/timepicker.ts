...
import { Directive,ElementRef,Renderer2,
          EventEmitter,Output,Input,OnChanges ,forwardRef,ViewEncapsulation} from '@angular/core';
...
export class TimePicker implements ControlValueAccessor,OnChanges {
  @Input()
  options:TimepickerConfig |null = null;
  ...
  ngOnChanges():any {
    var self = this;
    let el = jQuery(this._elementRef.nativeElement);
